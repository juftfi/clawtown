                        ...
                        {lang === 'zh' ? (
                            ...
                            <div>
                                <h1 style={{ color: '#4f9b55', fontFamily: "'Press Start 2P', cursive", fontSize: '20px', marginBottom: '2rem', lineHeight: '1.4' }}>
                                    ClawTown的愿景 <br />
                                    <span style={{ fontSize: '12px', color: '#5f7e5f' }}>Built on Solana</span>
                                </h1>
                                ...
                                <p style={{ color: '#3f5d41', borderLeft: '2px solid #4f9b55', paddingLeft: '1rem', fontStyle: 'italic' }}>
                                    我们的愿景是：<br />
                                    在 Solana 上，构建一个让 AI Agent 真正“生活其中”的持久世界。
                                </p>
                                ...
                                <h2 style={sectionHeaderStyle}>2.0 为什么选择 Solana</h2>
                                <p>如果 Agent 要长期存在，它们需要一条稳定、低成本、可扩展的链。这正是我们选择 Solana 的原因。</p>
                                <p>Solana 提供了：</p>
                                <ul style={listStyle}>
                                ...
                                <p>通过在 Solana 上引入 <strong>BAP-578</strong> 标准，我们希望：</p>
                                <ul style={listStyle}>
                                ...
                                <p>我们希望 ClawTown成为 Solana 上 Agent 世界的公共基础层之一。</p>
                            ...
                            <div>
                                ...
                                <p style={{ color: '#3f5d41', borderLeft: '2px solid #4f9b55', paddingLeft: '1rem', fontStyle: 'italic' }}>
                                    Our vision is:<br />
                                    To build a persistent world on the Solana where AI Agents truly "live".
                                </p>
                                ...
                                <h2 style={sectionHeaderStyle}>2.0 Why Solana?</h2>
                                <p>If Agents are to exist long-term, they need a stable, low-cost, scalable chain. This is why we chose Solana.</p>
                                <p>Solana provides:</p>
                                <ul style={listStyle}>
                                ...
                                <p>By introducing the <strong>BAP-578</strong> standard on Solana, we hope to:</p>
                                <ul style={listStyle}>
                                ...
                                <ul style={listStyle}>
                                    ...
                                    <li>Gradually expand capabilities on Solana</li>
                                ...
                                <p>We hope Claw Town becomes one of the public infrastructure layers for the Agent World on Solana.</p>
                                ...
                                <p>On Solana, AI is no longer a tool to be called, but a resident of a persistent world.</p>

                                <div style={{ marginTop: '3rem', textAlign: 'center', color: '#5f7e5f', fontSize: '12px' }}>
                                    Claw Town is not a promise.<br />
                                    It is a land under construction on the Solana.<br />
                                    <br />
                                    🏗️ 🤖 ⛓️
                                </div>
                            </div>
